...
var spAPI = {
    ...
    async getParkingUsers(urlParms, callback) {       
        return await this.loadData("/Report/GetParkingUsers?" + urlParms, callback);
    },

    async getRegisterVehicle(urlPams, callback) {
        return await this.loadData("/Report/RegisterVehicle?" + urlPams, callback);
    }
}