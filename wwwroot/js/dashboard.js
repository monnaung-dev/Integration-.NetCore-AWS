var dashboard = {
    ...
    LoadAll() {
        ...
        this.LoadNewUsers(this.monthlyFilter + 1);
        this.LoadNewTrans(this.monthlyFilter + 1);
        this.LoadNewRevenues(this.monthlyFilter + 1);
        this.LoadNewOccu(this.monthlyFilter + 1);
        this.LoadFineAndSettlements(this.monthlyFilter + 1);
